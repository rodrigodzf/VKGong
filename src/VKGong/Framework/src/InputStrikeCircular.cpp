...
InputStrikeCircular::InputStrikeCircular(CircularImperfectPlate *comp, double th, double r,
				   double startTime, double duration,
				   double fm)
    : Input(comp)
{
    logMessage(1, "Creating  strike: %f, %f, %f, %f, %f", th, r, startTime,
	       duration, fm);

    // Non-dimensionalization is included in the strike
...
InputStrikeCircular::~InputStrikeCircular()
{
    delete[] P;

}

void InputStrikeCircular::runTimestep(int n, double *s, double *s1, double *s2)
{
